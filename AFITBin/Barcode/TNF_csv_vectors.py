...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan  8 09:47:35 2024
...
split_files = os.listdir('/home/sayeh/Barcode/')
#print(split_files)
...
for file in split_files:
    result =  nucleotide_frequency('/home/sayeh/Barcode/' + file,K=4, just_count=False)
    # Do something with the result, such as saving it to a file or further analysis
    # For example, to save the result to a CSV file:
    result.to_csv(f"/home/sayeh/res_bar/results_tnf_.csv")
...
concatenated_results.to_csv('/home/sayeh/res_bar/combined_results_tnf_.csv')
...
data = pd.read_csv('/home/sayeh/res_bar/combined_results_tnf_.csv')
...
data_sorted.to_csv('/home/sayeh/res_bar/combined_results_sorted_tnf_.csv', index=False)

t = pd.read_csv('/home/sayeh/res_bar/combined_results_tnf_.csv').head()
j = pd.read_csv('/home/sayeh/res_bar/combined_results_sorted_tnf_.csv').head()
